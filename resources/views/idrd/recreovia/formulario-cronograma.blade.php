...
<div class="content">
    <div id="main" class="row" data-url="{{ url('programacion') }}">
        ...
        <div class="col-xs-12 col-md-12">
            <div class="row">
                <form action="{{ url('programacion/gestores/procesar') }}" method="post">
                    <fieldset>
                    	<div class="col-md-6 form-group {{ $errors->has('Id_Punto') ? 'has-error' : '' }}">
                    	...
                    	<div class="col-md-6 form-group {{ $errors->has('Id_Jornada') ? 'has-error' : '' }}">
                    	...
                    	<div class="col-md-3 form-group {{ $errors->has('Desde') ? 'has-error' : '' }}">
                    		<label for="">Desde</label>
							<input type="text" class="form-control" name="Desde" data-role="datepicker" data-rel="fecha_inicio" value="{{ $cronograma ? $cronograma['Desde'] : old('Desde') }}" placeholder="Desde">
                    	</div>
                    	<div class="col-md-3 form-group {{ $errors->has('Hasta') ? 'has-error' : '' }}">
                    		<label for="">Hasta</label>
							<input type="text" class="form-control" name="Hasta" data-role="datepicker" data-rel="fecha_fin" value="{{ $cronograma ? $cronograma['Hasta'] : old('Hasta') }}" placeholder="Hasta">
                    	</div>
                    	<div class="col-md-6 form-group {{ $errors->has('recreovia') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            ...
                            @endif
                            <a href="{{ url('programacion/gestores') }}" class="btn btn-default">Volver</a>
                        </div>
                    </fieldset>
                </form>
            </div>
